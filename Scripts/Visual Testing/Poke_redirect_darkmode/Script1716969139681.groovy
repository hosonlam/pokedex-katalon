...
WebUI.click(findTestObject('Object Repository/Page_PokDex/label (1)'))

WebUI.click(findTestObject('Object Repository/Page_PokDex/div_Region_pokeball__box github__icon'))
